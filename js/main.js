...
(function () {
	...
	function windowLoadInit() {
		...
		// 		var autoplayTimeout = data.autoplayTimeout ? data.autoplayTimeout : 2000;
		// 		var responsiveXs = data.responsiveXs ? data.responsiveXs : 1;
		// 		var responsiveSm = data.responsiveSm ? data.responsiveSm : 1;
		// 		var responsiveMd = data.responsiveMd ? data.responsiveMd : 1;
		// 		var responsiveLg = data.responsiveLg ? data.responsiveLg : 1;
		// 		var responsivexLg = data.responsivexLg ? data.responsivexLg : 1;
